...
CREATE TABLE `user` (
  ...
  `ConfirmPassword` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
INSERT INTO `user` VALUES (1,'Dhananjay','Hulge','djay','ZGpheTEyMw==','null','dhananjay@aryamantechnologies.com','9850200383',0,1,NULL,NULL,NULL,NULL);
